...
- **check log** — вручную перечитать лог-файл
- **auto** — автоматически перечитывать лог через заданный интервал (1–999 секунд)
- **alert** — звуковой сигнал при обнаружении нового матча (при включённом auto)
- **all** — показать все ранговые режимы в выпадающем меню
- **total** — показать общее количество игр
- **table** — отображение статистики в виде таблицы
